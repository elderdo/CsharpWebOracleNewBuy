<%@ Page Title="CLS CCB" Language="C#" MasterPageFile="~/NewBuy.Master" AutoEventWireup="true" CodeBehind="CCB.aspx.cs" Inherits="NewBuy.CLS.CCB" %>
...
<div id="tabs">
    ...
    <div id="tabs-CCB">
        <div class="toolbar">
            ...
            <button id="ccbButton5" title="Program" value="">Program</button>
    ...
    <script type="text/javascript">
                ...
                buttons: {
                    "Select": function () {
                        ...
                        if (pgmgrid_sel_id) {
                            ...
                            //Set button value
                            jQuery('#ccbButton5').prop('value', pgmgrid_sel_id);
        ...
        $(function () {
            ...
            $("#listCCB").jqGrid({
                ...
                datatype: 'json',
                mtype: 'POST',
                postData: { AssetManager: "", Part_no: "", ActivityStatus: "", ProgramCode: "", ViewHistory: "" }, //Add default custom post parameters
                serializeGridData: function (postData) {
                    ...
                    //Get Program Code
                    postData.ProgramCode = jQuery('#ccbButton5').prop('value');
        ...
        $(function () {
            //Create jqGrid, set options
            $("#listProgram").jqGrid({
                url: "CCB.aspx/getPgmGrid",
                datatype: 'json',
                mtype: 'POST',
                postData: { ProgramCode: "0" }, //Add default custom post parameters
                serializeGridData: function (postData) {
                    //Get Program
                    var program = jQuery('#ccbButton5').prop('value');
