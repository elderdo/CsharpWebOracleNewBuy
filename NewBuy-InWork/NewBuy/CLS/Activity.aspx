<%@ Page Title="CLS Activity" Language="C#" MasterPageFile="~/NewBuy.Master" AutoEventWireup="true" CodeBehind="Activity.aspx.cs" Inherits="NewBuy.CLS.Activity" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="tabs-Requirement">
        <div class="toolbar">
            ...
            <button id="reqButton3" title="Program" value="">Program</button>
...
<div id="lookup-program" title="Select a Program">
    <div id="programGridWrapper" class="ui-jqgrid gridWrapper">
        <table id="listProgram"></table>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContentjQuery" runat="server">
    <script type="text/javascript">
        ...
        jQuery(function () {
            ...
            .click(function () {
                ...
                //Open Dialog
                $("#lookup-program").dialog("open");

                //Update grid size
                $("#listProgram").setGridWidth($("#programGridWrapper").width());
                $("#listProgram").setGridHeight(300);
            ...
            $("#lookup-program").dialog({
                ...
                buttons: {
                    "Select": function () {
                        //Get selected row from program lookup
                        var pgmgrid_sel_id = $('#listProgram').jqGrid('getGridParam', 'selrow');
                        if (pgmgrid_sel_id) {
                            //Clear all other buttons
                            jQuery('[id ^= reqButton]').prop('value', '');

                            //Set button value
                            jQuery('#reqButton3').prop('value', pgmgrid_sel_id);
    ...
    $(function () {
        ...
        $("#listReq").jqGrid({
            ...
            datatype: 'json',
            mtype: 'POST',
            postData: { AssetManager: "", Part_no: "", ProgramCode: "", ViewHistory: "" }, //Add default custom post parameters
            serializeGridData: function (postData) {
                ...
                //Get Program
                postData.ProgramCode = jQuery('#reqButton3').prop('value');
            ...
            colModel: [
                        ...
                        { name: 'network', label: 'Network', sorttype: 'text', align: 'left', width: 180 },
    ...
    $(function () {
        //Create jqGrid, set options
        $("#listProgram").jqGrid({
            url: "Activity.aspx/getPgmGrid",
            datatype: 'json',
            mtype: 'POST',
            postData: { ProgramCode: "0" }, //Add default custom post parameters
            serializeGridData: function (postData) {
                //Get Program
                var program = jQuery('#reqButton3').prop('value');
                postData.ProgramCode = program;
            ...
            loadComplete: function (data) {
                var mygrid = jQuery("#listProgram")[0];
                mygrid.addJSONData(data.d);
            },
            loadError: function (xhr, status, error) {
                var mygrid = jQuery("#listProgram")[0];
                ...
                ErrorHandling(xhr, "program grid");
            },
            loadui: 'block', //Loading message options
            autowidth: true,
            height: '100%',
            ...
            viewrecords: true, //Show total records in pager
            sortable: true, //Allow sorting
            sortname: 'program_code', //Default sort field
            sortorder: 'asc', //Default sort field direction, asc/desc
            gridview: true,
            hidegrid: false,
            rownumbers: false,
            caption: '',
            colModel: [
                        { name: 'program_code', label: 'Code', sorttype: 'text', align: 'center', width: '50' },
                        { name: 'program_name', label: 'Name', sortable: false, sorttype: 'text', align: 'left' }
                      ],
            jsonReader: {
                root: "rows",
                page: "currentPage",
        ...
        //Add Navigation Bar
        $("#listProgram").jqGrid('navGrid', '#pagerProgram',
                { cloneToTop: true,
                    edit: false,
                    add: false,
                    del: false,
