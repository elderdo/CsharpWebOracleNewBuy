<%@ Page Title="CCAD CCB" Language="C#" MasterPageFile="~/NewBuy.Master" AutoEventWireup="true" CodeBehind="CCB.aspx.cs" Inherits="NewBuy.CCAD.CCB" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#listCCB").jqGrid({
                ...
                datatype: 'json',
                mtype: 'POST',
                postData: { AssetManager: "", Part_no: "", ActivityStatus: "" }, //Add default custom post parameters
                ...
                colModel: [
                            ...
                            { name: 'spo_cost', label: 'Cost', sorttype: 'currency', align: 'right' },
                    ...
                    if (selectedOrderRows.length > 0) {
                        ...
                        $.ajax({
                            ...
                            error: function (jqXHR, status, error) {
                                ...
                                //Show error dialog
                                ErrorHandling(jqXHR, "reject order");
                                return false;
                            }
                        });
                    }
        ...
        $(function () {
            ...
            $("#listActivity").jqGrid({
                ...
                loadError: function (xhr, status, error) {
                    ...
                    ErrorHandling(xhr, "activity status grid");
                },
                loadui: 'block', //Loading message options
                autowidth: true,
                height: '100%',
